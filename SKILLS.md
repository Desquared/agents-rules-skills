...
| ios-swift-concurrency-expert *(by AvdLee)* | Expert guidance on Swift 6 strict concurrency, resolving data races, Actor usage, and Sendable conformance. | `npx skills add https://github.com/AvdLee/Swift-Concurrency-Agent-Skill --skill swift-concurrency-expert` | [SKILL.md](https://github.com/AvdLee/Swift-Concurrency-Agent-Skill/skills/swift-concurrency-expert/SKILL.md) |
| ios-core-data-expert *(by AvdLee)* | Specialized agent instructions for CoreData and SwiftData optimization, context management, and fetch performance. | `npx skills add https://github.com/AvdLee/Core-Data-Agent-Skill --skill core-data-expert` | [SKILL.md](https://github.com/AvdLee/Core-Data-Agent-Skill/skills/core-data-expert/SKILL.md) |
| ios-swift-testing-expert *(by AvdLee)* | AI assistance for writing robust unit tests using the modern Swift Testing framework. | `npx skills add https://github.com/AvdLee/Swift-Testing-Agent-Skill --skill swift-testing-expert` | [SKILL.md](https://github.com/AvdLee/Swift-Testing-Agent-Skill/skills/swift-testing-expert/SKILL.md) |
| ios-xcode-build-orchestrator *(by AvdLee)* | Orchestrates the analysis and optimization of Xcode build times. | `npx skills add https://github.com/avdlee/xcode-build-optimization-agent-skill --skill xcode-build-orchestrator` | [SKILL.md](https://github.com/avdlee/xcode-build-optimization-agent-skill/skills/xcode-build-orchestrator/SKILL.md) |
| ios-xcode-project-analyzer *(by AvdLee)* | Analyzes Xcode project settings (.pbxproj) for suboptimal build configurations. | `npx skills add https://github.com/avdlee/xcode-build-optimization-agent-skill --skill xcode-project-analyzer` | [SKILL.md](https://github.com/avdlee/xcode-build-optimization-agent-skill/skills/xcode-project-analyzer/SKILL.md) |
| ios-xcode-compilation-analyzer *(by AvdLee)* | Analyzes Swift compilation logs to identify slow-compiling files and functions. | `npx skills add https://github.com/avdlee/xcode-build-optimization-agent-skill --skill xcode-compilation-analyzer` | [SKILL.md](https://github.com/avdlee/xcode-build-optimization-agent-skill/skills/xcode-compilation-analyzer/SKILL.md) |
| ios-xcode-build-fixer *(by AvdLee)* | Automatically fixes identified build bottlenecks in Xcode projects. | `npx skills add https://github.com/avdlee/xcode-build-optimization-agent-skill --skill xcode-build-fixer` | [SKILL.md](https://github.com/avdlee/xcode-build-optimization-agent-skill/skills/xcode-build-fixer/SKILL.md) |
| ios-xcode-build-benchmark *(by AvdLee)* | Benchmarks Xcode build times before and after optimizations. | `npx skills add https://github.com/avdlee/xcode-build-optimization-agent-skill --skill xcode-build-benchmark` | [SKILL.md](https://github.com/avdlee/xcode-build-optimization-agent-skill/skills/xcode-build-benchmark/SKILL.md) |
| ios-spm-build-analysis *(by AvdLee)* | Analyzes Swift Package Manager (SPM) dependencies for build time impacts. | `npx skills add https://github.com/avdlee/xcode-build-optimization-agent-skill --skill spm-build-analysis` | [SKILL.md](https://github.com/avdlee/xcode-build-optimization-agent-skill/skills/spm-build-analysis/SKILL.md) |
| ios-update-swiftui-apis *(by AvdLee)* | Refactors deprecated SwiftUI code to modern, supported APIs. | `npx skills add https://github.com/avdlee/swiftui-agent-skill --skill update-swiftui-apis` | [SKILL.md](https://github.com/avdlee/swiftui-agent-skill/skills/update-swiftui-apis/SKILL.md) |
